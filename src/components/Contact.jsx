    ...
    const handleForm = (e) => {
        ...
        toast.promise(
            ...
            }),
            {
                ...
                error: (err) => `Failed: ${err.text || "Unknown error"}`,
            }
        );
    };

    return (
        <section className={`pt-24 pb-12 ${dark ? 'bg-[#0C0C0C]' : 'bg-white'}`} id="contact">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between bg-tartiary rounded-lg md:p-8 p-4">
                    <div className="w-full md:w-1/2 p-4">
                        <form ref={formRef} onSubmit={handleForm} className="space-y-4">
                            {/* radio input */}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="message"
                                    required
                                    className="mt-2 py-2.5 px-4 block w-full rounded-md shadow-sm focus:outline-none focus:ring focus:ring-primary resize-none"
